...
PackageSelector = () => {
  ...
  let NavigateToLshapeEstimateForm=useNavigate()
    ...
    <span className="block text-gray-800 font-semibold">{pkg.tag3}</span>
        ...
        >
          <motion.button
            ...
            onClick={()=>{
              NavigateToLshapeEstimateForm("/kitcheninterior/layout/lshape-size")
            }}
          >
            Back
          </motion.button>
          <motion.button
            ...
            onClick={()=>{
              NavigateToLshapeEstimateForm("/kitcheninterior/layout/lshape-size/package/estimate-form")
            }}
          >
            Next
          </motion.button>
