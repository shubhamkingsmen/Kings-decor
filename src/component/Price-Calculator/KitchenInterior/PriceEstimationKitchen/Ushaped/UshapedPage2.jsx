...
function UshapedPage2() {
  ...
  let NavigateToUshapedPackage=useNavigate()
  ...
  const layouts = [{ id: "U-shaped", name: "U-shaped", img: Ushape }];
      ...
      >
        ...
        >
          <motion.button
            ...
            onClick={()=>{
              NavigateToUshapedPackage("/kitcheninterior/layout")
            }}
          >
            Back
          </motion.button>
          <motion.button
            ...
            onClick={()=>{
              NavigateToUshapedPackage("/kitcheninterior/layout/ushape-size/package")
            }}
          >
            Next
          </motion.button>
