...
const PackageSelector = () => {
  ...
  let NavigateToUshapeEstimate=useNavigate()
   ...
   <span className="block text-gray-800 font-semibold">{pkg.tag3}</span>
        ...
        >
          <motion.button
            ...
            onClick={()=>{
            NavigateToUshapeEstimate("/kitcheninterior/layout/ushape-size")
          ...
          <motion.button
            ...
            onClick={()=>{
            NavigateToUshapeEstimate("/kitcheninterior/layout/ushape-size/package/estimate-form")
