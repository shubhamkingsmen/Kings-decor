...
const PackageSelector = () => {
  ...
  let NavigateToParallelEstimate=useNavigate()
   ...
   <span className="block text-gray-800 font-semibold">{pkg.tag3}</span>
        ...
        >
          <motion.button
            ...
            onClick={()=>{
              NavigateToParallelEstimate("/kitcheninterior/layout/parallel-size")
            }}
          >
            Back
          </motion.button>
          <motion.button
            ...
            onClick={()=>{
              NavigateToParallelEstimate("/kitcheninterior/layout/parallel-size/package/estimate-form")
            }}
          >
            Next
          </motion.button>
