...
let NavigateToFinalPage=useNavigate()
    ...
    <span className="block text-gray-800 font-semibold">{pkg.tag3}</span>
        ...
        >
          <motion.button
            ...
            onClick={()=>{
              NavigateToFinalPage("/homeinterior/bhk/rooms-design")
            }}
          >
            Back
          </motion.button>
          <motion.button
            ...
            onClick={()=>{
              NavigateToFinalPage("/homeinterior/bhk/rooms-design/package/estimate-form")
            }}
          >
            Next
          </motion.button>
